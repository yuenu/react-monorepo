...
function AddDeliveryAddress(props: ModalProps) {
  return (
    ...
    >
      <Dialog.Backdrop>
        <div className="fixed inset-0 bg-red-200" />
      </Dialog.Backdrop>

      <Dialog.Title className="mb-4 text-2xl text-center text-blue-800">
        Add Delivery Address
      </Dialog.Title>
      ...
      <div className="flex justify-end gap-2 mt-4">
        <button
          type="button"
          className="px-3 py-1 text-white bg-blue-900"
          onClick={props.push?.("verification-result")}
        >
          Verify Address
        </button>
        <button type="button" className="px-3 py-1 text-white bg-green-600">
          Add
        </button>
        <button
          type="button"
...
function VerificationResult(props: ModalProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end gap-2 mt-4">
        <a href="#" className="px-3 py-1 text-blue-700">
          link to help
        </a>
        <button type="button" className="px-3 py-1 text-white bg-green-600">
